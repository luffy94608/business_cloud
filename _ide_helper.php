...
namespace {
    ...
    class Easemob extends \Aobo\Easemob\Facades\Easemob{
         ...
         */
        public static function getToken(){
            return \Aobo\Easemob\EasemobClass::getToken();
        }
        ...
        public static function createUser($username, $password, $nickname = ''){
            return \Aobo\Easemob\EasemobClass::createUser($username, $password, $nickname);
        }
         ...
         * @static 
         */
        public static function createUsers($options){
            return \Aobo\Easemob\EasemobClass::createUsers($options);
        }
        ...
        public static function resetPassword($username, $newpassword){
            return \Aobo\Easemob\EasemobClass::resetPassword($username, $newpassword);
        }
        ...
        public static function getUser($username){
            return \Aobo\Easemob\EasemobClass::getUser($username);
        }
        ...
        public static function getUsers($limit = 0){
            return \Aobo\Easemob\EasemobClass::getUsers($limit);
        }
        ...
        public static function getUsersForPage($limit = 0, $cursor = ''){
            return \Aobo\Easemob\EasemobClass::getUsersForPage($limit, $cursor);
        }
        ...
        public static function mkdirs($dir, $mode = 511){
            return \Aobo\Easemob\EasemobClass::mkdirs($dir, $mode);
        }
         ...
         * @static 
         */
        public static function writeCursor($filename, $content){
            return \Aobo\Easemob\EasemobClass::writeCursor($filename, $content);
        }
         ...
         * @static 
         */
        public static function readCursor($filename){
            return \Aobo\Easemob\EasemobClass::readCursor($filename);
        }
        ...
        public static function deleteUser($username){
            return \Aobo\Easemob\EasemobClass::deleteUser($username);
        }
        ...
        public static function deleteUsers($limit){
            return \Aobo\Easemob\EasemobClass::deleteUsers($limit);
        }
        ...
        public static function editNickname($username, $nickname){
            return \Aobo\Easemob\EasemobClass::editNickname($username, $nickname);
        }
        ...
        public static function addFriend($username, $friend_name){
            return \Aobo\Easemob\EasemobClass::addFriend($username, $friend_name);
        }
         ...
         * @static 
         */
        public static function deleteFriend($username, $friend_name){
            return \Aobo\Easemob\EasemobClass::deleteFriend($username, $friend_name);
        }
         ...
         * @static 
         */
        public static function showFriends($username){
            return \Aobo\Easemob\EasemobClass::showFriends($username);
        }
        ...
        public static function getBlacklist($username){
            return \Aobo\Easemob\EasemobClass::getBlacklist($username);
        }
         ...
         * @static 
         */
        public static function addUserForBlacklist($username, $usernames){
            return \Aobo\Easemob\EasemobClass::addUserForBlacklist($username, $usernames);
        }
         ...
         * @static 
         */
        public static function deleteUserFromBlacklist($username, $blocked_name){
            return \Aobo\Easemob\EasemobClass::deleteUserFromBlacklist($username, $blocked_name);
        }
        ...
        public static function isOnline($username){
            return \Aobo\Easemob\EasemobClass::isOnline($username);
        }
         ...
         * @static 
         */
        public static function getOfflineMessages($username){
            return \Aobo\Easemob\EasemobClass::getOfflineMessages($username);
        }
         ...
         * @static 
         */
        public static function getOfflineMessageStatus($username, $msg_id){
            return \Aobo\Easemob\EasemobClass::getOfflineMessageStatus($username, $msg_id);
        }
         ...
         * @static 
         */
        public static function deactiveUser($username){
            return \Aobo\Easemob\EasemobClass::deactiveUser($username);
        }
        ...
        public static function activeUser($username){
            return \Aobo\Easemob\EasemobClass::activeUser($username);
        }
        ...
        public static function disconnectUser($username){
            return \Aobo\Easemob\EasemobClass::disconnectUser($username);
        }
        ...
        public static function uploadFile($filePath){
            return \Aobo\Easemob\EasemobClass::uploadFile($filePath);
        }
         ...
         * @static 
         */
        public static function downloadFile($uuid, $shareSecret){
            return \Aobo\Easemob\EasemobClass::downloadFile($uuid, $shareSecret);
        }
         ...
         * @static 
         */
        public static function downloadThumbnail($uuid, $shareSecret){
            return \Aobo\Easemob\EasemobClass::downloadThumbnail($uuid, $shareSecret);
        }
         ...
         * @static 
         */
        public static function sendText($from, $target_type, $target, $content, $ext){
            return \Aobo\Easemob\EasemobClass::sendText($from, $target_type, $target, $content, $ext);
        }
         ...
         * @static 
         */
        public static function sendCmd($from, $target_type, $target, $action, $ext){
            return \Aobo\Easemob\EasemobClass::sendCmd($from, $target_type, $target, $action, $ext);
        }
         ...
         * @static 
         */
        public static function sendImage($filePath, $from, $target_type, $target, $filename, $ext){
            return \Aobo\Easemob\EasemobClass::sendImage($filePath, $from, $target_type, $target, $filename, $ext);
        }
         ...
         * @static 
         */
        public static function sendAudio($filePath, $from, $target_type, $target, $filename, $length, $ext){
            return \Aobo\Easemob\EasemobClass::sendAudio($filePath, $from, $target_type, $target, $filename, $length, $ext);
        }
         ...
         * @static 
         */
        public static function sendVedio($filePath, $from, $target_type, $target, $filename, $length, $thumb, $thumb_secret, $ext){
            return \Aobo\Easemob\EasemobClass::sendVedio($filePath, $from, $target_type, $target, $filename, $length, $thumb, $thumb_secret, $ext);
        }
         ...
         * @static 
         */
        public static function sendFile($filePath, $from, $target_type, $target, $filename, $length, $ext){
            return \Aobo\Easemob\EasemobClass::sendFile($filePath, $from, $target_type, $target, $filename, $length, $ext);
        }
         ...
         * @static 
         */
        public static function getGroups($limit = 0){
            return \Aobo\Easemob\EasemobClass::getGroups($limit);
        }
         ...
         * @static 
         */
        public static function getGroupsForPage($limit = 0, $cursor = ''){
            return \Aobo\Easemob\EasemobClass::getGroupsForPage($limit, $cursor);
        }
         ...
         * @static 
         */
        public static function getGroupDetail($group_ids){
            return \Aobo\Easemob\EasemobClass::getGroupDetail($group_ids);
        }
        ...
        public static function createGroup($options){
            return \Aobo\Easemob\EasemobClass::createGroup($options);
        }
         ...
         * @static 
         */
        public static function modifyGroupInfo($group_id, $options){
            return \Aobo\Easemob\EasemobClass::modifyGroupInfo($group_id, $options);
        }
        ...
        public static function deleteGroup($group_id){
            return \Aobo\Easemob\EasemobClass::deleteGroup($group_id);
        }
        ...
        public static function getGroupUsers($group_id){
            return \Aobo\Easemob\EasemobClass::getGroupUsers($group_id);
        }
         ...
         * @static 
         */
        public static function addGroupMember($group_id, $username){
            return \Aobo\Easemob\EasemobClass::addGroupMember($group_id, $username);
        }
         ...
         * @static 
         */
        public static function addGroupMembers($group_id, $usernames){
            return \Aobo\Easemob\EasemobClass::addGroupMembers($group_id, $usernames);
        }
         ...
         * @static 
         */
        public static function deleteGroupMember($group_id, $username){
            return \Aobo\Easemob\EasemobClass::deleteGroupMember($group_id, $username);
        }
         ...
         * @static 
         */
        public static function deleteGroupMembers($group_id, $usernames){
            return \Aobo\Easemob\EasemobClass::deleteGroupMembers($group_id, $usernames);
        }
        ...
        public static function getGroupsForUser($username){
            return \Aobo\Easemob\EasemobClass::getGroupsForUser($username);
        }
         ...
         * @static 
         */
        public static function changeGroupOwner($group_id, $options){
            return \Aobo\Easemob\EasemobClass::changeGroupOwner($group_id, $options);
        }
         ...
         * @static 
         */
        public static function getGroupBlackList($group_id){
            return \Aobo\Easemob\EasemobClass::getGroupBlackList($group_id);
        }
         ...
         * @static 
         */
        public static function addGroupBlackMember($group_id, $username){
            return \Aobo\Easemob\EasemobClass::addGroupBlackMember($group_id, $username);
        }
         ...
         * @static 
         */
        public static function addGroupBlackMembers($group_id, $usernames){
            return \Aobo\Easemob\EasemobClass::addGroupBlackMembers($group_id, $usernames);
        }
         ...
         * @static 
         */
        public static function deleteGroupBlackMember($group_id, $username){
            return \Aobo\Easemob\EasemobClass::deleteGroupBlackMember($group_id, $username);
        }
         ...
         * @static 
         */
        public static function deleteGroupBlackMembers($group_id, $usernames){
            return \Aobo\Easemob\EasemobClass::deleteGroupBlackMembers($group_id, $usernames);
        }
         ...
         * @static 
         */
        public static function createChatRoom($options){
            return \Aobo\Easemob\EasemobClass::createChatRoom($options);
        }
         ...
         * @static 
         */
        public static function modifyChatRoom($chatroom_id, $options){
            return \Aobo\Easemob\EasemobClass::modifyChatRoom($chatroom_id, $options);
        }
         ...
         * @static 
         */
        public static function deleteChatRoom($chatroom_id){
            return \Aobo\Easemob\EasemobClass::deleteChatRoom($chatroom_id);
        }
        ...
        public static function getChatRooms(){
            return \Aobo\Easemob\EasemobClass::getChatRooms();
        }
         ...
         * @static 
         */
        public static function getChatRoomDetail($chatroom_id){
            return \Aobo\Easemob\EasemobClass::getChatRoomDetail($chatroom_id);
        }
         ...
         * @static 
         */
        public static function getChatRoomJoined($username){
            return \Aobo\Easemob\EasemobClass::getChatRoomJoined($username);
        }
         ...
         * @static 
         */
        public static function addChatRoomMember($chatroom_id, $username){
            return \Aobo\Easemob\EasemobClass::addChatRoomMember($chatroom_id, $username);
        }
        ...
        public static function addChatRoomMembers($chatroom_id, $usernames){
            return \Aobo\Easemob\EasemobClass::addChatRoomMembers($chatroom_id, $usernames);
        }
         ...
         * @static 
         */
        public static function deleteChatRoomMember($chatroom_id, $username){
            return \Aobo\Easemob\EasemobClass::deleteChatRoomMember($chatroom_id, $username);
        }
         ...
         * @static 
         */
        public static function deleteChatRoomMembers($chatroom_id, $usernames){
            return \Aobo\Easemob\EasemobClass::deleteChatRoomMembers($chatroom_id, $usernames);
        }
         ...
         * @static 
         */
        public static function getChatRecord($ql){
            return \Aobo\Easemob\EasemobClass::getChatRecord($ql);
        }
         ...
         * @static 
         */
        public static function getChatRecordForPage($ql, $limit, $cursor){
            return \Aobo\Easemob\EasemobClass::getChatRecordForPage($ql, $limit, $cursor);
        }
        ...
        public static function postCurl($url, $body, $header, $type = 'POST'){
            return \Aobo\Easemob\EasemobClass::postCurl($url, $body, $header, $type);
        }
