...
return [
     ...
     */
    'app_id'  => env('WECHAT_APPID', 'wx9f0f2c946e2c3f1e'),         // AppID
    'secret'  => env('WECHAT_SECRET', '9f45cb60c378973121dc1eb30de1862a'),     // AppSecret
    'token'   => env('WECHAT_TOKEN', 'hollo'),          // Token
    'aes_key' => env('WECHAT_AES_KEY', 'YfT7HXUMJBTxyUxYi9z84UzFbbN8m2D6HmvFaHYGrln'),
     ...
     */
     'payment' => [
         ...
         'notify_url'           => env('WECHAT_PAYMENT_NOTIFY', 'path/to/your/key'),      // 回调地址！！！！
